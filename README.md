...
- 增加国内环境安装教程
- 增加纯IPV6环境安装教程
- 修复部分机器无法监听`127.0.0.1:62789`的BUG
- 更改`reality`协议默认域名为`www.icloud.com`
- 支持`windows`系统
...
3. 双击运行`x-ui.exe`程序
4. 使用默认信息登录面板
5. 如果需要后台运行请谷歌搜索`Windows任务调度器`使用教程
...
[![Stargazers over time](https://starchart.cc/admin8800/3x-ui.svg?variant=adaptive)](https://starchart.cc/admin8800/3x-ui)
